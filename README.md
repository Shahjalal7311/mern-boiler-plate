...
This project develop by Foyzul Karim vai. I have cloned it and i will add some features according to my need.
Here is the details of Foyzul Karim vai:
...
- Node.js - evented I/O for the backend [ node >= v18.0.0 ]
...
You can find the videos in the [YouTube playlist](https://www.youtube.com/playlist?list=PLEYpvDF6qy8aUl1KnB1oaZbwLE2oPcZmz). These  videos are only in **Bangla**
